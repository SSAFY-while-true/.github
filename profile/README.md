# SSAFY 서울 2반 알고리즘 스터디 `whie True:`🚀
...
1. **문제 선정** 🎯  
   - 매주 조원 합의로 2~3문제(혹은 상황에 따라 조정)를 선정합니다.  
...
## 파일 업로드 규칙 📂
1. 파일명에는 문제의 출처, 문제 번호, 문제 제목이 포함되어야 합니다. 문제 이름을 적을 때는 띄어쓰기를 생략합니다.  
   - 예시: `BOJ16236아기상어.py`
2. 자신이 푼 문제는 **반드시!!** 자신의 리포지토리에 업로드합니다.  
   - 진행 주차에 따라 폴더를 나눕니다. 예를 들면 다음과 같습니다:
     ...
     └── 202502_4
     ```
3. 폴더 구조는 아래와 같이 구성합니다. (리포지토리 이름인 **닉네임**은 반드시 깃허브 닉네임과 통일)  
```
[닉네임]
 ㄴ [년도+월]_[주차]
      ㄴ README.md
...
ppower-dev
 ㄴ 202502_3
      ...
      ㄴ BOJ1001문제2.py
```
4. 각 주차 폴더에 있는 `README.md`에는 **각자 풀 문제 목록**을 적습니다.
...
## 커뮤니케이션 💭
- 문제 선정, 코드리뷰 장소 선정 등은 **Mattermost**를 통해 진행합니다.
- 코드리뷰는 **대면 형식**으로 진행합니다.

---

### 문의 ❓
- 궁금한 점이나 제안 사항이 있다면 **이슈(Issue)**를 남겨주시거나, **Mattermost** 개인 메시지로 연락 부탁드립니다.
